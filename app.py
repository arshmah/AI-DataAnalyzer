...
def display_pdf_in_sidebar(pdf_path, file_name):
    try:
        ...
        if image_paths:
            ...
            images = convert_from_path(pdf_path, poppler_path=r"C:\Users\tk\Downloads\Release-24.08.0-0\poppler-24.08.0\Library\bin")# This will render all pages by default
...
st.title("SeekRAG: Your personal Data Analyzer")
